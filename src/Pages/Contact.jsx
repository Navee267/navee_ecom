    ...
    return (
        <div className='w-full h-screen bg-slate-300'>
            <div className='flex flex-col w-full items-center'>
                <h2 className=' uppercase m-10 text-3xl font-display font-normal'>SignUp For Our NewsLetter</h2>
                <form action="#" className='flex flex-col space-y-2 '>
                    <input type="email" placeholder='Enter Email' className='p-2 w-96' />
                    <button type='submit' className='bg-black p-2 text-white border rounded-lg'>Sign Up</button>
                </form>
            </div>
            <div className='grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-6 justify-center pt-20 relative'>
                {
                    images.map((image, index) => (
                        <img className='w-80' alt='contactimg' src={image} key={index} />
                    ))
                }
                <button className='absolute top-64 left-1/3 right-1/3 bg-slate-800 text-white p-3 hover:bg-slate-400 transform ease-in-out duration-300'>Follow Us On Instagram</button>
            </div>
            ...
            <footer class="bg-white dark:bg-gray-800 pt-4 pb-8 xl:pt-8">
                <div class="max-w-screen-lg px-4 mx-auto text-white xl:max-w-screen-xl sm:px-6 md:px-8 dark:text-gray-300">
                    <h2 className='text-center text-white text-2xl font-display font-bold mb-3'>Navee</h2>
